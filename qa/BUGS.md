...
|----|-------|----------|----------|--------|
| QA-001 | Cars spawn too low (and filterGroup conflict) caused drop | Critical | P0 | Verified Fixed |
| QA-002 | Pause/Start button fails to stop simulation | High | P1 | Found |
